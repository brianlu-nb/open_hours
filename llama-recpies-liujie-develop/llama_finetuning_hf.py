...
from utils.data_collator import DataCollatorForSeq2Seq, DataCollatorForLanguageModeling

import transformers
from transformers import TrainingArguments, Trainer, TrainerCallback

from ft_datasets.unified_dataset import UnifiedDataset
from ft_datasets.halu_dataset import DetectDataset
from ft_datasets.qu_dataset import QUDataset
from ft_datasets.multitask_dataset import MultiTaskDataset
from ft_datasets.content_quality_dataset import ContentQualityDataset
from ft_datasets.content_genre_dataset import ContentGenreDataset
from ft_datasets.open_hours_dataset import OpenHoursDataset
...
dataset_map = {
    ...
    'content_quality_dataset': ContentQualityDataset,
    'content_genre_dataset': ContentGenreDataset,
    'open_hours_dataset': OpenHoursDataset,
}
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    target_modules: str = field(default="q_proj,v_proj") #,k_proj,gate_proj,up_proj,down_proj
...
def main():
    ...
    dataset_train = dataset_map[data_args.dataset](
        tokenizer,
        data_args,
        train=True
    )

    dataset_val = dataset_map[data_args.dataset](
        tokenizer,
        data_args,
        train=False
    )
    ...
    if training_args.do_train:
        ...
        # should use deepspeed==0.13.1 to avoid error
        trainer.save_state()
