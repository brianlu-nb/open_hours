...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="pair-v2",
        help="which judgement prompt to use",
    )
    ...
    if args.mode == "single":
        ...
        judges = make_judge_pairwise(args.judge_model, judge_prompts, args.judgement_prompt)
    ...
    question_default = [q for q in questions if q.get("category") not in NEED_REF_CATS]
